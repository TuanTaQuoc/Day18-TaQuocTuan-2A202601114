...
def extract_metadata(text: str) -> dict:
    ...
    lowered = text.lower()
    category = "policy"
    if any(term in lowered for term in ["mật khẩu", "vpn", "dữ liệu", "bảo mật"]):
        category = "it"
    elif any(term in lowered for term in ["lương", "phụ cấp", "tạm ứng", "chi phí"]):
        category = "finance"
    elif any(term in lowered for term in ["nghỉ", "thử việc", "mentor", "đào tạo"]):
        category = "hr"
